...
def main():
    ...
    clin_recoded, new_var = pf.feature_recode(clin_typ2, var)
    del clin_typ2 
    gc.collect()

    # Compute mean or mode of the features
    mean_mode = pf.mean_mode_calc(clin_recoded, new_var)

    print('Preprocess data')
    # Preprocessing data
    pf.preprocessing_data(data = clin_recoded, feature_info = new_var, mean_mode = mean_mode, result_dir = res_dir, result_suffix = suffix)
